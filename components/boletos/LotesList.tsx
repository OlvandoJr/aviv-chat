...
import { ChevronRight, Loader2, FileText, User, Calendar, Layers } from 'lucide-react'
...
export default function LotesList({ lotes }: { lotes: Lote[] }) {
  if (lotes.length === 0) {
    return (
...
function LoteRow({ lote }: { lote: Lote }) {
  ...
  return (
    <div>
      {/* Cabeçalho do lote */}
      <button onClick={toggle} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition-colors text-left">
