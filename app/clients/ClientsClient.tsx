...
export default function ClientsClient({ initial, inboxes = [] }: {
  initial: any[]
      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        ...
        {inboxes.length > 0 && (
          <button onClick={() => setNovoAberto(true)}
            className="shrink-0 flex items-center gap-1.5 text-sm px-3 py-2 rounded-lg bg-emerald-600 text-white hover:bg-emerald-700">
